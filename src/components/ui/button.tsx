  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        // TCM-specific variants
        hero: "bg-gold text-foreground font-semibold shadow-lg hover:shadow-xl hover:scale-105 active:scale-100",
        ...
        jade: "bg-jade text-primary-foreground hover:brightness-110 shadow-sm hover:shadow-md",
        gold: "bg-gold text-foreground font-semibold hover:brightness-110 shadow-lg",
        subtle: "bg-jade-light text-jade hover:bg-jade hover:text-primary-foreground",
      },
      size: {
