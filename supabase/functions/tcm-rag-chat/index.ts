...
const TCM_BILINGUAL_GLOSSARY: Array<{
  ...
  { en: ['heart fire'], he: ['אש לב', 'שין הואו'], pinyin: ['xin huo'], category: 'syndrome' },
  { en: ['stomach fire'], he: ['אש קיבה', 'וויי הואו'], pinyin: ['wei huo'], category: 'syndrome' },
  { en: ['kidney essence deficiency'], he: ['חוסר ג\'ינג כליה', 'כליה ג\'ינג שו'], pinyin: ['shen jing xu'], category: 'syndrome' },
  { en: ['liver blood deficiency'], he: ['חוסר דם כבד', 'גאן שואה שו'], pinyin: ['gan xue xu'], category: 'syndrome' },
  { en: ['heart qi deficiency'], he: ['חוסר צי לב', 'לב צי שו'], pinyin: ['xin qi xu'], category: 'syndrome' },
  { en: ['lung yin deficiency'], he: ['חוסר יין ריאה', 'ריאה יין שו'], pinyin: ['fei yin xu'], category: 'syndrome' },
  { en: ['stomach yin deficiency'], he: ['חוסר יין קיבה', 'קיבה יין שו'], pinyin: ['wei yin xu'], category: 'syndrome' },
  { en: ['spleen yang deficiency'], he: ['חוסר יאנג טחול', 'טחול יאנג שו'], pinyin: ['pi yang xu'], category: 'syndrome' },
  { en: ['wind cold'], he: ['רוח קור', 'פנג האן'], pinyin: ['feng han'], category: 'syndrome' },
  { en: ['wind heat'], he: ['רוח חום', 'פנג רה'], pinyin: ['feng re'], category: 'syndrome' },
  { en: ['exterior syndrome'], he: ['תסמונת חיצונית', 'ביאו'], pinyin: ['biao'], category: 'pattern' },
  { en: ['interior syndrome'], he: ['תסמונת פנימית', 'לי'], pinyin: ['li'], category: 'pattern' },
  { en: ['excess syndrome'], he: ['תסמונת עודף', 'שי'], pinyin: ['shi'], category: 'pattern' },
  { en: ['deficiency syndrome'], he: ['תסמונת חוסר', 'שו'], pinyin: ['xu'], category: 'pattern' },
  ...
  { en: ['bladder', 'urinary bladder'], he: ['שלפוחית', 'פאנג גואנג', 'שלפוחית שתן'], pinyin: ['pang guang'], category: 'organ' },
  ...
  { en: ['pericardium'], he: ['קרום הלב', 'שין באו'], pinyin: ['xin bao'], category: 'organ' },
  { en: ['triple burner', 'triple heater', 'san jiao'], he: ['שלוש מוקדים', 'סאן ג\'יאו'], pinyin: ['san jiao'], category: 'organ' },
  ...
  { en: ['bleeding', 'bloodletting'], he: ['הקזת דם', 'שיתי שואה'], category: 'technique' },
  { en: ['gua sha', 'scraping'], he: ['גואה שה', 'גרידה'], pinyin: ['gua sha'], category: 'technique' },
  { en: ['auricular', 'ear acupuncture'], he: ['דיקור אוזן', 'אוריקולותרפיה'], category: 'technique' },
  
  // === SYMPTOMS (EXPANDED) ===
  { en: ['headache', 'head pain', 'cephalalgia'], he: ['כאב ראש', 'כאבי ראש', 'מיגרנה', 'צפלאלגיה'], category: 'symptom' },
  { en: ['migraine'], he: ['מיגרנה', 'כאב ראש חד צדדי'], category: 'symptom' },
  { en: ['tension headache'], he: ['כאב ראש מתח', 'כאב ראש מתחי'], category: 'symptom' },
  { en: ['insomnia', 'sleep disorder', 'sleeplessness'], he: ['נדודי שינה', 'אינסומניה', 'הפרעות שינה', 'קושי להירדם'], category: 'symptom' },
  { en: ['fatigue', 'tiredness', 'exhaustion'], he: ['עייפות', 'חולשה', 'תשישות', 'אין כוח'], category: 'symptom' },
  { en: ['pain'], he: ['כאב', 'כאבים'], category: 'symptom' },
  { en: ['back pain', 'low back pain', 'lumbago'], he: ['כאב גב', 'כאבי גב תחתון', 'לומבלגיה', 'כאב גב תחתון'], category: 'symptom' },
  { en: ['neck pain', 'cervical pain'], he: ['כאב צוואר', 'כאבי צוואר', 'צווארון'], category: 'symptom' },
  { en: ['shoulder pain'], he: ['כאב כתף', 'כאבי כתפיים'], category: 'symptom' },
  { en: ['knee pain'], he: ['כאב ברך', 'כאבי ברכיים'], category: 'symptom' },
  { en: ['joint pain', 'arthralgia'], he: ['כאבי מפרקים', 'כאב מפרק', 'ארתרלגיה'], category: 'symptom' },
  { en: ['anxiety'], he: ['חרדה', 'אנקסייטי', 'פחד'], category: 'symptom' },
  { en: ['depression'], he: ['דיכאון', 'עצבות', 'מצב רוח ירוד'], category: 'symptom' },
  { en: ['stress'], he: ['לחץ', 'מתח', 'סטרס', 'עומס'], category: 'symptom' },
  { en: ['digestive issues', 'digestion', 'digestive disorders'], he: ['בעיות עיכול', 'עיכול', 'מערכת עיכול', 'הפרעות עיכול'], category: 'symptom' },
  { en: ['constipation'], he: ['עצירות', 'קושי ביציאות'], category: 'symptom' },
  { en: ['diarrhea'], he: ['שלשול', 'דיאריאה', 'שלשולים'], category: 'symptom' },
  { en: ['nausea'], he: ['בחילה', 'בחילות'], category: 'symptom' },
  { en: ['vomiting'], he: ['הקאה', 'הקאות'], category: 'symptom' },
  { en: ['bloating', 'abdominal distension'], he: ['נפיחות', 'נפיחות בטן', 'גזים'], category: 'symptom' },
  { en: ['acid reflux', 'heartburn', 'gerd'], he: ['צרבת', 'ריפלוקס', 'חומציות'], category: 'symptom' },
  { en: ['menstrual pain', 'dysmenorrhea', 'period pain'], he: ['כאבי מחזור', 'דיסמנוריאה', 'כאבי וסת', 'כאבי פריוד'], category: 'symptom' },
  { en: ['irregular menstruation', 'irregular periods'], he: ['מחזור לא סדיר', 'אי סדירות במחזור'], category: 'symptom' },
  { en: ['amenorrhea', 'no period'], he: ['היעדר מחזור', 'אמנוריאה'], category: 'symptom' },
  { en: ['pms', 'premenstrual syndrome'], he: ['תסמונת קדם וסתית', 'פמס'], category: 'symptom' },
  { en: ['infertility'], he: ['אי פוריות', 'פוריות', 'קושי להיכנס להריון'], category: 'symptom' },
  { en: ['hot flashes', 'hot flushes'], he: ['גלי חום', 'הבזקי חום'], category: 'symptom' },
  { en: ['menopause'], he: ['גיל המעבר', 'מנופאוזה'], category: 'symptom' },
  { en: ['dizziness', 'vertigo'], he: ['סחרחורת', 'ורטיגו', 'סחרחורות'], category: 'symptom' },
  { en: ['tinnitus', 'ringing ears'], he: ['טינטון', 'צלצולים באוזניים'], category: 'symptom' },
  { en: ['blurred vision', 'eye problems'], he: ['טשטוש ראייה', 'בעיות עיניים', 'ראייה מטושטשת'], category: 'symptom' },
  { en: ['dry eyes'], he: ['יובש בעיניים', 'עיניים יבשות'], category: 'symptom' },
  { en: ['cough', 'coughing'], he: ['שיעול'], category: 'symptom' },
  { en: ['asthma', 'wheezing'], he: ['אסתמה', 'צפצופים', 'קוצר נשימה'], category: 'symptom' },
  { en: ['shortness of breath', 'dyspnea'], he: ['קוצר נשימה', 'קושי בנשימה'], category: 'symptom' },
  { en: ['palpitations', 'heart racing'], he: ['דפיקות לב', 'פלפיטציות', 'לב רץ'], category: 'symptom' },
  { en: ['edema', 'swelling', 'water retention'], he: ['בצקת', 'נפיחות', 'אגירת נוזלים'], category: 'symptom' },
  { en: ['night sweats'], he: ['הזעות לילה', 'הזעה בלילה'], category: 'symptom' },
  { en: ['spontaneous sweating'], he: ['הזעה ספונטנית', 'הזעה'], category: 'symptom' },
  { en: ['cold limbs', 'cold hands feet'], he: ['גפיים קרות', 'ידיים קרות', 'רגליים קרות'], category: 'symptom' },
  { en: ['frequent urination', 'nocturia'], he: ['הטלת שתן תכופה', 'השתנה תכופה', 'קימה בלילה'], category: 'symptom' },
  { en: ['weight gain'], he: ['עלייה במשקל', 'השמנה'], category: 'symptom' },
  { en: ['weight loss'], he: ['ירידה במשקל', 'רזון'], category: 'symptom' },
  { en: ['hair loss', 'alopecia'], he: ['נשירת שיער', 'התקרחות', 'אלופציה'], category: 'symptom' },
  { en: ['skin rash', 'eczema', 'dermatitis'], he: ['פריחה', 'אקזמה', 'דרמטיטיס', 'בעיות עור'], category: 'symptom' },
  { en: ['acne'], he: ['אקנה', 'פצעונים'], category: 'symptom' },
  { en: ['psoriasis'], he: ['פסוריאזיס', 'ספחת'], category: 'symptom' },
  { en: ['allergies', 'allergic rhinitis'], he: ['אלרגיה', 'אלרגיות', 'נזלת אלרגית'], category: 'symptom' },
  { en: ['common cold', 'flu', 'influenza'], he: ['הצטננות', 'שפעת', 'צינון'], category: 'symptom' },
  { en: ['fever'], he: ['חום', 'חום גוף', 'חום גבוה'], category: 'symptom' },
  { en: ['sore throat'], he: ['כאב גרון', 'דלקת גרון'], category: 'symptom' },
  { en: ['irritability', 'anger'], he: ['עצבנות', 'כעס', 'רגזנות'], category: 'symptom' },
  { en: ['poor memory', 'forgetfulness'], he: ['זיכרון לקוי', 'שכחנות', 'בעיות זיכרון'], category: 'symptom' },
  { en: ['poor concentration', 'brain fog'], he: ['קושי בריכוז', 'ערפל מוחי', 'חוסר ריכוז'], category: 'symptom' },
  
  // === DIAGNOSTIC TERMS ===
  { en: ['pulse diagnosis', 'pulse'], he: ['אבחון דופק', 'דופק'], pinyin: ['mai zhen'], category: 'diagnosis' },
  { en: ['tongue diagnosis', 'tongue'], he: ['אבחון לשון', 'לשון'], pinyin: ['she zhen'], category: 'diagnosis' },
  { en: ['wiry pulse'], he: ['דופק מתוח', 'דופק מיתרי'], pinyin: ['xian mai'], category: 'diagnosis' },
  { en: ['slippery pulse'], he: ['דופק חלקלק', 'דופק גולש'], pinyin: ['hua mai'], category: 'diagnosis' },
  { en: ['weak pulse'], he: ['דופק חלש'], pinyin: ['ruo mai'], category: 'diagnosis' },
  { en: ['rapid pulse'], he: ['דופק מהיר'], pinyin: ['shuo mai'], category: 'diagnosis' },
  { en: ['slow pulse'], he: ['דופק איטי'], pinyin: ['chi mai'], category: 'diagnosis' },
  { en: ['red tongue'], he: ['לשון אדומה'], category: 'diagnosis' },
  { en: ['pale tongue'], he: ['לשון חיוורת'], category: 'diagnosis' },
  { en: ['thick coating', 'tongue coating'], he: ['ציפוי עבה', 'ציפוי לשון'], category: 'diagnosis' },
  
  // === COMMON FORMULAS ===
  { en: ['xiao yao san', 'free and easy wanderer'], he: ['שיאו יאו סאן', 'פורמולת הנודד החופשי'], pinyin: ['xiao yao san'], category: 'formula' },
  { en: ['liu wei di huang wan', 'six ingredient pill'], he: ['ליו וויי די הואנג וואן', 'כדור שש המרכיבים'], pinyin: ['liu wei di huang wan'], category: 'formula' },
  { en: ['bu zhong yi qi tang'], he: ['בו ג\'ונג יי צי טאנג'], pinyin: ['bu zhong yi qi tang'], category: 'formula' },
  { en: ['gui pi tang'], he: ['גווי פי טאנג'], pinyin: ['gui pi tang'], category: 'formula' },
  { en: ['si wu tang', 'four substance'], he: ['סי וו טאנג', 'מרתח ארבע החומרים'], pinyin: ['si wu tang'], category: 'formula' },
  { en: ['tian ma gou teng yin'], he: ['טיאן מא גואו טנג יין'], pinyin: ['tian ma gou teng yin'], category: 'formula' },
  { en: ['long dan xie gan tang'], he: ['לונג דאן שיה גאן טאנג'], pinyin: ['long dan xie gan tang'], category: 'formula' },
  { en: ['chuan xiong cha tiao san'], he: ['צ\'ואן שיונג צ\'ה טיאו סאן'], pinyin: ['chuan xiong cha tiao san'], category: 'formula' },
  
  // === COMMON HERBS ===
  { en: ['ginseng', 'ren shen'], he: ['ג\'ינסנג', 'רן שן'], pinyin: ['ren shen'], category: 'herb' },
  { en: ['astragalus', 'huang qi'], he: ['אסטרגלוס', 'הואנג צי'], pinyin: ['huang qi'], category: 'herb' },
  { en: ['angelica', 'dang gui'], he: ['אנג\'ליקה', 'דאנג גווי'], pinyin: ['dang gui'], category: 'herb' },
  { en: ['licorice', 'gan cao'], he: ['ליקוריץ', 'גאן צאו'], pinyin: ['gan cao'], category: 'herb' },
  { en: ['ginger', 'sheng jiang'], he: ['ג\'ינג\'ר', 'זנגביל', 'שנג ג\'יאנג'], pinyin: ['sheng jiang'], category: 'herb' },
  { en: ['cinnamon', 'gui zhi', 'rou gui'], he: ['קינמון', 'גווי ג\'י', 'רואו גווי'], pinyin: ['gui zhi', 'rou gui'], category: 'herb' },
  { en: ['peony', 'bai shao', 'chi shao'], he: ['אדמונית', 'באי שאו', 'צ\'י שאו'], pinyin: ['bai shao', 'chi shao'], category: 'herb' },
  { en: ['rehmannia', 'di huang'], he: ['רהמניה', 'די הואנג'], pinyin: ['di huang'], category: 'herb' },
  { en: ['bupleurum', 'chai hu'], he: ['בופלורום', 'צ\'אי הו'], pinyin: ['chai hu'], category: 'herb' },
  
  // === COMMON ACUPOINTS (EXPANDED) ===
  { en: ['LI4', 'hegu', 'large intestine 4'], he: ['LI4', 'האגו', 'לי 4', 'מעי גס 4'], pinyin: ['he gu'], category: 'point' },
  { en: ['LV3', 'liver 3', 'taichong'], he: ['LV3', 'טאי צ\'ונג', 'כבד 3'], pinyin: ['tai chong'], category: 'point' },
  { en: ['ST36', 'zusanli', 'stomach 36'], he: ['ST36', 'זו סאן לי', 'קיבה 36'], pinyin: ['zu san li'], category: 'point' },
  { en: ['SP6', 'sanyinjiao', 'spleen 6'], he: ['SP6', 'סאן יין ג\'יאו', 'טחול 6'], pinyin: ['san yin jiao'], category: 'point' },
  { en: ['BL23', 'shenshu', 'bladder 23'], he: ['BL23', 'שן שו', 'שלפוחית 23'], pinyin: ['shen shu'], category: 'point' },
  { en: ['GV20', 'baihui', 'governing vessel 20'], he: ['GV20', 'באי הווי', 'דו 20'], pinyin: ['bai hui'], category: 'point' },
  { en: ['GB20', 'fengchi', 'gallbladder 20'], he: ['GB20', 'פנג צ\'י', 'כיס מרה 20'], pinyin: ['feng chi'], category: 'point' },
  { en: ['PC6', 'neiguan', 'pericardium 6'], he: ['PC6', 'ניי גואן', 'קרום לב 6'], pinyin: ['nei guan'], category: 'point' },
  { en: ['HT7', 'shenmen', 'heart 7'], he: ['HT7', 'שן מן', 'לב 7'], pinyin: ['shen men'], category: 'point' },
  { en: ['KI3', 'taixi', 'kidney 3'], he: ['KI3', 'טאי שי', 'כליה 3'], pinyin: ['tai xi'], category: 'point' },
  { en: ['LU7', 'lieque', 'lung 7'], he: ['LU7', 'ליה צ\'יואה', 'ריאה 7'], pinyin: ['lie que'], category: 'point' },
  { en: ['CV6', 'qihai', 'conception vessel 6'], he: ['CV6', 'צי האי', 'רן 6'], pinyin: ['qi hai'], category: 'point' },
  { en: ['CV12', 'zhongwan', 'conception vessel 12'], he: ['CV12', 'ג\'ונג וואן', 'רן 12'], pinyin: ['zhong wan'], category: 'point' },
  { en: ['yintang', 'third eye'], he: ['יין טאנג', 'עין שלישית'], pinyin: ['yin tang'], category: 'point' },
  { en: ['taiyang', 'temple'], he: ['טאי יאנג', 'רקה'], pinyin: ['tai yang'], category: 'point' },
];
